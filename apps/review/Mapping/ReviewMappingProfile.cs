    ...
    public class ReviewMappingProfile : Profile
    {
        public ReviewMappingProfile()
        {
            ...
            CreateMap<ReviewModel, ProtoReview>()
                ...
                .ForMember(dest => dest.BookingId, opt => opt.MapFrom(src => src.BookingId.HasValue ? src.BookingId.Value.ToString() : string.Empty))
                .ForMember(dest => dest.RentalId, opt => opt.MapFrom(src => src.RentalId.HasValue ? src.RentalId.Value.ToString() : string.Empty))
            ...
            CreateMap<Review.CreateReviewRequest, ReviewModel>()
                ...
                .ForMember(dest => dest.BookingId, opt => opt.MapFrom(src => src.BookingId != "" ? Guid.Parse(src.BookingId) : (Guid?)null))
                .ForMember(dest => dest.UserId, opt => opt.MapFrom(src => Guid.Parse(src.UserId)))
                .ForMember(dest => dest.RentalId, opt => opt.MapFrom(src => src.RentalId != "" ? Guid.Parse(src.RentalId) : (Guid?)null))
